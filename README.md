...
The full section, with the flags and the exit rule it shares with `validate`:
[`cosyte convert`](documentation/convert-and-map-codes.md#cosyte-convert).

## `cosyte map-codes`

The full section, with the flags and the value-free unmapped signal:
[`cosyte map-codes`](documentation/convert-and-map-codes.md#cosyte-map-codes).
